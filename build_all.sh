...
cp ./build-Win32/bin/HelloWorld.exe ./cross-platform-binaries/windows_x86
cp ./build-Win64/bin/HelloWorld.exe ./cross-platform-binaries/windows_x64
cp ./build-linux_x86_64/bin/HelloWorld ./cross-platform-binaries/linux_x86_64
cp ./build-linux_aarch64/bin/HelloWorld ./cross-platform-binaries/linux_aarch64
